...
const createUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const safeUser = yield user_model_1.default.findByPk(user.id, { attributes: USER_SAFE_ATTRIBUTES });
...
const getAllUsers = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const users = yield user_model_1.default.findAll({ attributes: USER_SAFE_ATTRIBUTES });
...
const updateUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const safeUser = yield user_model_1.default.findByPk(id, { attributes: USER_SAFE_ATTRIBUTES });
        res.status(200).json({
