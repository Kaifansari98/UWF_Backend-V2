...
const reuploadSubmissionFile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        yield submission.update({ [field]: newFileName });
        res.status(200).json({
...
exports.reuploadSubmissionFile = reuploadSubmissionFile;
